...
$notify_url     = "http://www.fan-qiang.com/sshweb/alipay/notify_url.php"; //交易过程中服务器通知的页面 要用 http://格式的完整路径
$return_url     = "http://www.fan-qiang.com/sshweb/alipay/return_url.php"; //付完款后跳转的页面 要用 http://格式的完整路径
$show_url       = "http://www.fan-qiang.com/"        //你网站商品的展示地址
