...
* Date     : 25.10.2009
* Author   : Forcemdt
* Web page : http://www.md-t.org
* country  : Turkey ( Turqia - Turkiye )
* Modifier : @vparano (https://twitter.com/vparano)
* Last Modified at 2010.4.2
******************************************************************/
...
OUT;
		 ...
		 $Maps_flv1='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_flv)).'" rel="nofollow"><font color="#FF0000">Download FLV</font></a>&nbsp;&nbsp;';
		 }
		 if (file_mp4hd != "file_mp4hd") {
		 $Maps_flv2='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_mp4hd)).'" rel="nofollow"><font color="#FF0000">Download MP4HD</font></a>&nbsp;&nbsp;';
		 }
		 if (file_mp4hq != "file_mp4hq") {
		 $Maps_flv3='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_mp4hq)).'" rel="nofollow"><font color="#FF0000">Download MP4HQ</font></a>&nbsp;&nbsp;';
		 }
		 if (file_flvh264 != "file_flvh264") {
		 $Maps_flv4='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_flvh264)).'" rel="nofollow"><font color="#FF0000">Download FLVH264</font></a>&nbsp;&nbsp;';
		 }
		 if (file_flvhq != "file_flvhq") {
		 $Maps_flv5='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_flvhq)).'" rel="nofollow"><font color="#FF0000">Download FLVHQ</font></a>&nbsp;&nbsp;';
		 }
		 if (file_flvHD1 != "file_flvHD") {
		 $Maps_flv6='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_flvHD1)).'" rel="nofollow"><font color="#FF0000">Download FLVHD1</font></a>&nbsp;&nbsp;';
		 }
		 if (file_flvHD2 != "file_flvHD2") {
		 $Maps_flv7='<a class="watch-comment-auth" href="'.proxifyURL(sprintf('%s',file_flvHD2)).'" rel="nofollow"><font color="#FF0000">Download FLVHD2</font></a>';
		 }
